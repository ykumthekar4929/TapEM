...
public class GetEventsTask extends AsyncTask<Void, Void, List<EventDTO>> {

    CallBack callBack;
    String user_id;
    EventDTO[] eventDTOS;

    public GetEventsTask(String user_id, CallBack callBack) {
    ...
    protected List<EventDTO> doInBackground(Void... voids) {
        String url = AppConstrants.SERVER_BASE_URL + "events/events_data/?created_by_user=" + Integer.parseInt(user_id);
